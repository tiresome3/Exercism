...
public class WeatherStation
{
    ...
    public Outlook ShortTermOutlook
    {
        get
        {
            ...
            {
                return reading.Pressure < 10m && reading.Temperature < 30m ? 
                    Outlook.Cool : reading.Temperature > 50 ? 
                    Outlook.Good : Outlook.Warm;
            }
        }
    }
    ...
    public Outlook LongTermOutlook
    {
        get
        {
            return reading.WindDirection == WindDirection.Southerly || reading.WindDirection == WindDirection.Easterly 
                ...
                reading.WindDirection == WindDirection.Westerly ? Outlook.Rainy :
                throw new ArgumentException();
        }
    }
